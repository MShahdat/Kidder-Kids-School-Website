...
const con = [
  {
    icon: <FaLocationDot />,
    label: '145/2 Block-D Gulshan, Dhaka-1200',
  },
  {
    icon: <MdEmail />,
    label: 'kider@gmail.com',
  },
  {
    icon: <MdAddCall />,
    label: '+8801885374041',
        ...
        <motion.div className='mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 space-y-4 gap-4'>
          {
            con.map((item, idx) => (
              <motion.div
                ...
                <p className='text-[17px] mt-2 font-medium dark:text-white/80 text-black/80'>145/2 Block-D Gulshan, Dhaka-1200</p>
              </motion.div>
            ))
          }
        </motion.div>
